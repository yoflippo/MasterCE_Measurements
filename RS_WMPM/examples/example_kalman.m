...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% https://nl.mathworks.com/matlabcentral/fileexchange/13479-an-intuitive-introduction-to-kalman-filter
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% Approach: We measure (sample) the position of the train every dt seconds. But,
