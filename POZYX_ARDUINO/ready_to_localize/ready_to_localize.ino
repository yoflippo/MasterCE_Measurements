...
uint16_t anchors[num_anchors] = {0x6e49, 0x695f, 0x696c, 0x6e02};     // the network id of the anchors: change these to the network ids of your anchors.
int32_t anchors_x[num_anchors] = {1604, 539, 2054, 3182};               // anchor x-coorindates in mm
int32_t anchors_y[num_anchors] = {963, 4778, -1132, 1316};                  // anchor y-coordinates in mm
int32_t heights[num_anchors] = {1900, 650, 1900, 1400};              // anchor z-coordinates in mm
